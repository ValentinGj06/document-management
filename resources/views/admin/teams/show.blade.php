...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#team_files" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="team_files">
            @includeIf('admin.teams.relationships.teamFiles', ['files' => $team->teamFiles])
        </div>
    </div>
</div>
